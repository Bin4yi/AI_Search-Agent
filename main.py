...
def google_search(state: State):
    ...
    print(f"Conducting Google search for: {user_question}")
...
def bing_search(state: State):
    user_question = state.get("user_question", "")
    print(f"Conducting Bing search for: {user_question}")
...
def reddit_search(state: State):
    user_question = state.get("user_question", "")
    print(f"Conducting Reddit search for: {user_question}")
...
def analyze_reddit_posts(state: State):
    ...
    if not reddit_results or not reddit_results.get("organic"):
    ...
    try:
        ...
        for i , url in enumerate(selected_urls):
            print(f"Selected URL {i}: {url}")
        
    
    except Exception as e:
        print(f"Error occurred during Reddit analysis: {e}")
        selected_urls = []
...
def retrieve_reddit_posts(state: State):
    ...
    if reddit_post_data:
        print(f"Successfully retrieved {len(reddit_post_data)} Reddit posts.")
    else :
...
def synthesize_analyzes(state: State):
...
graph_builder.add_node("synthesize_analyzes", synthesize_analyzes)
...
graph_builder.add_edge("reddit_search", "retrieve_reddit_posts")
graph_builder.add_edge("analyze_reddit_posts", "retrieve_reddit_posts")

graph_builder.add_edge("retrieve_reddit_posts", "analyze_google_results")
graph_builder.add_edge("retrieve_reddit_posts", "analyze_bing_results")
graph_builder.add_edge("retrieve_reddit_posts", "analyze_reddit_results")
graph_builder.add_edge("analyze_google_results", "synthesize_analyzes")
graph_builder.add_edge("analyze_bing_results", "synthesize_analyzes")
graph_builder.add_edge("analyze_reddit_results", "synthesize_analyzes")

graph_builder.add_edge("synthesize_analyzes", END)
